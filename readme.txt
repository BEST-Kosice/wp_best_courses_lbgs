...
Installing "wp_best_courses_lbgs" can be done either by searching for "wp_best_courses_lbgs" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
