...
class wp_best_courses_lbgs {
	...
	/**
	 * The single instance of wp_best_courses_lbgs.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function __construct ( $file = '', $version = '1.0.0' ) {
		...
		$this->_token = 'wp_best_courses_lbgs';
		...
		if ( is_admin() ) {
			$this->admin = new wp_best_courses_lbgs_Admin_API();
		}
	...
	public function register_post_type ( $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$post_type = new wp_best_courses_lbgs_Post_Type( $post_type, $plural, $single, $description, $options );
	...
	public function register_taxonomy ( $taxonomy = '', $plural = '', $single = '', $post_types = array(), $taxonomy_args = array() ) {
		...
		$taxonomy = new wp_best_courses_lbgs_Taxonomy( $taxonomy, $plural, $single, $post_types, $taxonomy_args );
	...
	public function enqueue_scripts () {
		...
		wp_register_script( $this->_token . '-map', esc_url($this->assets_url) . 'js/map' . $this->script_suffix . '.js');
	...
	public function load_localisation () {
		load_plugin_textdomain( 'wp-best-courses-lbgs', false, dirname( plugin_basename( $this->file ) ) . '/lang/' );
	...
	/**
	 * Main wp_best_courses_lbgs Instance
	 *
	 * Ensures only one instance of wp_best_courses_lbgs is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
